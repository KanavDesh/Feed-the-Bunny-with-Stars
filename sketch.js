...
var empty, one_star, stars, starImg, g_star, star1, star2;
var balloon;
...
function setup() 
{
  ...
  g_star = createSprite(50, 20);
  g_star.addImage("os", one_star);
  g_star.addImage("s", stars);
  g_star.addImage("e", empty);
  g_star.scale = 0.2;

  balloon = createImg('baloon2.png');
  balloon.position(300, 400);
...
function draw() 
{
  ...
  {
    star1.destroy();
    g_star.changeImage("os", one_star);
  }
  
  if(collide(fruit,star2)==true)
  {
    star2.destroy();
    g_star.changeImage("s", stars);
  }
